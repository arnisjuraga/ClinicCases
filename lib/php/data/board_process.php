...
switch ($action) {
    ...
    case 'edit':
        ...
        $data = ['title' => $title, 'body' => $text, 'color' => $color, 'id' => $id];
...
if ($error[1]) {
    ...
    switch ($action) {
        case 'new':
            ...
            $response = ['error' => false, 'post_id' => $post_id];
        ...
        case 'edit':
            ...
            $response = ['error' => false, 'message' => 'Changes Saved'];
        ...
        case 'delete':
            ...
            $response = ['error' => false, 'message' => "Post Deleted"];
