...
switch ($type) {
    case 'user':
        ...
        $cols = ["username", "case_id", "date", "description", "time", "seconds"];
        ...
        if ($columns_only) {
            ...
            $data = ['val' => $val, 'date_start' => $date_start, 'date_end' => $date_end];
    ...
    case 'grp':
        ...
        $cols = ["username", "SUM(time)", "seconds"];
    ...
    case 'case';
        ...
        if ($columns_only) {
            ...
            $data = ['val' => $case_number, 'date_start' => $date_start, 'date_end' => $date_end];
