        ...
        if (!$error[1]) {
            ...
            foreach ($responsibles as $responsible) {
                ...
                if (stristr($responsible, '_grp_')) {
                    ...
                    $resps[] = $all_in_group;
                } elseif (stristr($responsible, '_spv_')) //user has selected a group that is defined by who the supervisor is
                {
            ...
            for ($i = 0; $i < sizeof($resps_flat); $i++) {
                ...
                $data = ['last_id' => $last_id, 'resp' => $resps_flat[$i]];
    ...
    case 'edit':
        ...
        if (!$error[1]) {
            ...
            for ($i = 0; $i < sizeof($resps_flat); $i++) {
                ...
                $data = ['last_id' => $event_id, 'resp' => $resps_flat[$i]];
