...
<div id="content" class="content_login">
    ...
    <div class="wrapper">
        ...
        <div class="new_account_left">
            ...
            <h1>Set Up Your <br>ClinicCases Account for
                <span style="color:<?php echo CC_SCHOOL_COLOR; ?>"><?php echo CC_PROGRAM_NAME; ?></span>
            </h1>
            <p>Submit the form to the right to apply for a ClinicCases account. Your application will be reviewed and approved by your administrator. If you have any questions, please contact your
                <a href="mailto:<?php echo CC_ADMIN_EMAIL; ?>">Administrator</a>
                .
            </p>
        ...
        <div class="new_account_right">
            ...
            <form name="newAccount">
                ...
                <p>
                    <label for
                    "first_name" class="req">First Name</label>
                    <input type="text" name="first_name" id="first_name">
                </p>

                <p>
                    <label for
                    "last_name" class="req">Last Name</label>
                    <input type="text" name="last_name" id="last_name">
                </p>

                <p>
                    <label for
                    "email" class="req">Email</label>
                    <input type="text" name="email" id="email">
                </p>

                <p>
                    <label for
                    "password" class="req">Password (at least 8 characters)</label>
                    <input type="password" name="password" id="password">
                </p>

                <p>
                    <label for
                    "confirm_password" class="req">Type again to confirm:</label>
                    <input type="password" name="confirm_password" id="confirm_password">
                </p>

                <p>
                    <label for
                    "grp" class="req">Select your group</label>                    <select name="grp">
                ...
                <p>
                    <label for
                    "mobile" class="req">Mobile Phone</label>
                    <input type="text" name="mobile_phone" id="mobile">
                </p>

                <p>
                    <label for
                    "home_phone">Home Phone</label>
                    <input type="text" name="home_phone" id="home_phone">
                </p>

                <p>
                    <label for
                    "timezone_offset" class="req">Your Time Zone</label>                    <select id="timezone" name="timezone_offset">
                ...
                <p>
                    <input type="button" id="sbmt" name="sbmt" value="Submit">
                </p>
