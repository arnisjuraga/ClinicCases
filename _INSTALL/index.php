...
<div id="content">
    ...
    <form name="config_form">
        ...
        <p>
            <label>Host</label>
            <input type="text" name="db_host" value="localhost" title="The address of your mysql server.  Usually localhost">
        </p>

        <p>
            <label>Database Username</label>
            <input type="text" name="db_user" value="" title="Your database username">
        </p>

        <p>
            <label>Database Password</label>
            <input type="text" name="db_pass" value="" title="Your database password">
        </p>

        <p>
            <label>Database Name</label>
            <input type="text" name="db_name" value="" title="The name of the database you are using for ClinicCases">
        </p>

        <p>
            <label>Password Salt</label>
            <input type="text" name="salt" value="<?php echo uniqid(); ?>" title="Salt used to secure passwords. The default value should be fine.">
        </p>

        <p>
            <label>Path to ClinicCases</label>
            <input type="text" name="cc_path" value="/var/www/cliniccases" title="The full path to ClinicCases on your server">
        </p>

        <p>
            <label>Path to Documents</label>
            <input type="text" name="doc_path" value="/var/cc_docs" title="You must create a directory outside of the web root to store uploaded documents in.  This directory must be writable.">
        </p>

        <p>
            <label>Base URL</label>
            <input type="text" name="base_url" value="https://yourserver.com/cliniccases/"
                   title="The url to your installation of ClinicCases.  Please ensure that your url has the correct protocol (http or https) and that it ends with a slash">
        </p>

        <p>
            <label>Domain</label>
            <input type="text" name="domain" value="https://yourserver.com" title="The domain of your web server.  No trailing slash">
        </p>

        <p>
            <label>Admin Email</label>
            <input type="text" name="admin_email" value="" title="The email address of the person who will answer questions about ClinicCases on a day-to-day basis.  Usually your clinic's administrator">
        </p>

        <p>
            <label>Default Email</label>
            <input type="text" name="default_email" value="no-reply@yourserver.com" title="The address that system emails will come from">
        </p>

        <p>
            <label>Your Program Name</label>
            <input type="text" name="program_name" value="Your Law Clinic's Name" title="The name of your clinic or organization">
        </p>

        <p>
            <label>Your School Color</label>
            <input type="text" name="school_color" value="#000000" title="An rgb or hex value">
        </p>

        <p>
            <label>Timekeeping Unit</label>
        ...
        <p>
            ...
            <input type="text" name="max_upload" value="10"
                   title="The maximum file size (in MB) that can be uploaded by users to your server. Note that the php.ini settings post_max_size and upload_max_filesize should be set to at least this value.">
        </p>

        <p>
            <label>Case Number Mask</label>
            <input type="text" name="mask" value="YYYY-Number"
                   title="Default case number format. Possible values: YYYY or YY for four digit or two digit year;ClinicType (derived from cm_clinic_type table) or CaseType (derived from cm_case_types table);Number or NumberInfinite - Number resets to one at the beginning of each year, NumberInifinite does not.Your mask must have at least a year value and Number/NumberInfinite, seperated by dash">
        </p>

        <p>
            <label>reCAPTCHA Public Key</label>
            <input type="text" value="(optional)" name="recaptcha_public"
                   title="The reCAPTCHA public key for this domain.  reCAPTCHA is used to prevent spam from the New Accounts form.  This is optional.  For more information, please visit http://recaptcha.net">
        </p>

        <p>
            <label>reCAPTCHA Private Key</label>
            <input type="text" value="(optional)" name="recaptcha_private"
                   title="The reCAPTCHA private key for this domain.  reCAPTCHA is used to prevent spam from the New Accounts form.  This is optional.  For more information, please visit http://recaptcha.net">
        </p>
