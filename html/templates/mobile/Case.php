    ...
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            ...
            <a class="btn btn-info navbar-btn btn-sm navbar-toggle collapsed" href="index.php?i=QuickAdd.php">
                Quick Add <i class="fa fa-plus"></i>
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="collapse-menu">
            <ul class="nav navbar-nav navbar-right">
                <li>
                    <a href="index.php?i=Home.php">Home</a>
                </li>
                <li class="active">
                    <a href="index.php?i=Cases.php">Cases</a>
                </li>
                <li>
                    <a href="index.php?i=Messages.php">Messages</a>
                    <?php if ($_SESSION['permissions']['view_board'] === '1'){ ?>
                <li>
                    <a href="index.php?i=Board.php">Board</a>
                    <?php } ?>
                <li>
                    <a href="index.php?i=QuickAdd.php">Quick Add</a>
                <li>
                    <a href="index.php?i=Logout.php&user=1">Logout</a>
            </ul>
        </div><!-- /.navbar-collapse -->
    </div><!-- /.container-fluid -->
</nav>
...
<div class="container">
    ...
    <div class="row">
        <div class="col-xs-12">
            <a href="index.php?i=Cases.php" class="btn btn-primary btn-sm">
        ...
        <div class="col-xs-12">
            <ul class="nav nav-tabs nav-tabs-responsive" role="tablist" id="myTab">
                <li role="presentation" class="active">
                    <a role="tab" data-toggle="tab" aria-controls="case notes" href="#caseNotes">
                        <span class="text">Case Notes</span>
                    </a>
                </li>
                <li role="presentation" class="next">
                    <a role="tab" data-toggle="tab" aria-controls="case data" href="#caseData">
                        <span class="text">Case Data</span>
                    </a>
                </li>
                <li role="presentation">
                    <a role="tab" data-toggle="tab" aria-controls="documents" href="#caseDocs">
                        <span class="text">Documents</span>
                    </a>
                </li>
                <li role="presentation">
                    <a role="tab" data-toggle="tab" aria-controls="contacts" href="#caseContacts">
                        <span class="text">Contacts</span>
                    </a>
                </li>
                <li role="presentation">
                    <a role="tab" data-toggle="tab" aria-controls="events" href="#caseEvents">
                                    ...
                                    <div class="panel-info">
                                        ...
                                        <ul>
                                            <?php foreach (array_filter($c) as $key => $value) {
                                                if (in_array($key, ['id', 'assoc_case', 'first_name', 'last_name'])) { //srip unnecessary elements
                                                    continue;
                                                } else {
                            ...
                            foreach ($events as $e) {
                                ...
                                <li style="list-style:none">
                                    <div class="panel panel-default">
                                        <div class="panel-body">
                                            <div class="panel-info">
                                                <h4><?php echo htmlspecialchars($task, ENT_QUOTES, 'UTF-8') . ' - ';
                                                    echo extract_date($start); ?></h4>
                                                <ul class="unstyled">
                                                    <li>
                                                        <span class="text-muted">Start:</span> <?php echo htmlspecialchars($e['start_text'], ENT_QUOTES, 'UTF-8'); ?>  </li>
                                                    <li>
                                                        <span class="text-muted">End:</span><?php echo htmlspecialchars($e['end_text'], ENT_QUOTES, 'UTF-8'); ?>  </li>
                                                    <li>
                                                        <span class="text-muted">All Day:</span><?php if ($e['all_day'] === '1') {
                                                            echo "Yes";
                                                        } else {
                                                            echo "No";
                                                        } ?>  </li>
                                                    <li>
                                                        <span class="text-muted">Where:</span><?php echo htmlspecialchars($e['location'], ENT_QUOTES, 'UTF-8'); ?>  </li>
                                                    <li>
                                                        <span class="text-muted">Notes:</span><?php echo nl2br(htmlspecialchars($e['notes'], ENT_QUOTES, 'UTF-8')); ?>  </li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
