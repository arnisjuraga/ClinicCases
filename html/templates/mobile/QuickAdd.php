        ...
        <div class="col-xs-12">
            <ul class="nav nav-tabs nav-tabs-responsive" role="tablist" id="qaTab">
                <li role="presentation" class="active">
                    <a role="tab" data-toggle="tab" aria-controls="Case Note" href="#qaCaseNote">
                        <span class="text">Case Note</span>
                    </a>
                </li>
                <li role="presentation" class="next">
                    <a role="tab" data-toggle="tab" aria-controls="Event" href="#qaEvent">
                        <span class="text">Event</span>
                    </a>
                </li>
                <li role="presentation">
                    <a role="tab" data-toggle="tab" aria-controls="Contact" href="#qaContact">
            ...
            <div class="tab-content">
                <div role="tabpanel" class="tab-pane active" id="qaCaseNote">
                    <?php if ($_SESSION['permissions']['add_case_notes'] === '1') { ?>
                        <form name="quick_cn">
                            <div class="form-group">
                                ...
                                "cn_case">Case:</label><select name="csenote_case_id" class="form-control" id="cn_case">
                            ...
                            <div class="form-group">
                                <label class="control-label" for
                                "cn_hours">Hours:</label>
                                <input type="text" class="form-control" id="cn_hours" name="csenote_hours" value="0">
                            </div>
                            <div class="form-group">
                                <label class="control-label" for
                                "cn_minutes">Minutes:</label>
                                <input type="text" class="form-control" name="csenote_minutes" id="cn_minutes" value="0">
                            </div>
                            <div class="form-group">
                                <label for
                                "csenote_description">Description</label><br/> <textarea name="csenote_description" id="csenote_description" class="form-control" rows="4" required></textarea>
                            </div>
                    ...
                    <?php } else {
                        echo "<p>You do not have permission to add case notes.</p>";
                    } ?>
                </div>
                <div role="tabpanel" class="tab-pane" id="qaEvent">
                    <?php if ($_SESSION['permissions']['add_events'] === '1') { ?>
                        <form name="quick_event">
                            ...
                            <div class="checkbox">
                                <label>
                                    <input type="checkbox" name="all_day" value="off">
                                    All Day?
                                </label>
                            </div>
                            <div class="form-group">
                    ...
                    <?php } else {
                        echo "<p>You do not have permission to add events.</p>";
                    } ?>
                </div>
                <div role="tabpanel" class="tab-pane" id="qaContact">
                    ...
                    <?php } else {
                        echo "<p>You do not have permission to add contacts.</p>";
                    } ?>
                </div>
            </div>
        </div>
