...
foreach ($case_notes_data as $case_notes) {
    ...
    echo "<div class='csenote' id='csenote_" . $case_notes['id'] . "'>
				<div class='csenote_bar'>
				<div class = 'csenote_bar_left'><img class='thumbnail-mask' src='" . thumbify($case_notes['picture_url']) . "'>&nbsp " . username_to_fullname($dbh,
            $case_notes['username']) . "</div><div class = 'csenote_bar_right'><span class='csenote_date'>" . extract_date($case_notes['date']) . "</span> &#183; <span class='csenote_time'>" . $time[0] . $time[1] . "</span>";
