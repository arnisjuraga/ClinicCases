        ...
        <div id="case">
            ...
            <form name="case_form" class="config_form" data-type="case">
                ...
                <p>
                    ...
                    <input name="case[]" type="text" class="val_add" title="Add a new case type">
                    <a href="#" class="change_config add" title="Add a new case_type"><img src="html/ico/add.png"></a>
                </p>
    ...
    <div class="config_item">
        ...
        <div id="courts">
            ...
            <form name="court_form" class="config_form" data-type="court">
                ...
                <p>
                    <input name="court[]" type="text" class="val_add" title="Add a new court">
                    <a href="#" class="change_config add" title="Add a new court"><img src="html/ico/add.png"></a>
                </p>
    ...
    <div class="config_item">
        ...
        <div id="dispo">
            ...
            <form name="dispo_form" class="config_form" data-type="dispo">
                ...
                <p>
                    <input name="dispo[]" type="text" class="val_add" title="Add a new disposition">
                    <a href="#" class="change_config add"><img src="html/ico/add.png" title="Add a new disposition"></a>
                </p>
                ...
                <?php foreach ($dispos as $d) {
                    ...
                    <p>
                        <input name="dispo[]" type="text" value="<?php echo htmlspecialchars($dispo, ENT_QUOTES, 'UTF-8'); ?>" data-id="<?php echo $id; ?>"
                               title="Delete <?php echo htmlspecialchars($dispo, ENT_QUOTES, 'UTF-8'); ?>">
        ...
        <div id="clinic">
            ...
            <form name="clinic_form" class="config_form config_form_multi" data-type="clinic">
                ...
                <p>
                    ...
                    <input name="clinic_name[]" type="text" class="val_add" title="Add a new clinic name">
                    <a href="#" class="change_config add"><img src="html/ico/add.png" title="Add a new clinic name"></a>
                </p>
    ...
    <div class="config_item">
        ...
        <div id="referral">
            ...
            <form name="referral_form" class="config_form" data-type="referral">
                ...
                <p>
                    <input name="referral[]" type="text" class="val_add" title="Add a new referral source">
                    <a href="#" class="change_config add"><img src="html/ico/add.png" title="Add a new referral source"></a>
                </p>
