...
if ($view === 'display') { ?>
    ...
    <span class="user_data_display_area" data-id="<?php echo $id; ?>">
        ...
        <div class="user_detail_left">
            ...
            <p>
                <label>First Name</label><?php echo htmlspecialchars($first_name, ENT_QUOTES, 'UTF-8'); ?></p>

            <p>
                <label>Last Name</label><?php echo htmlspecialchars($last_name, ENT_QUOTES, 'UTF-8'); ?></p>

            <p>
                <label>Email</label>
                <a href="mailto:<?php echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?>" target="_new"><?php echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?> </a>
            </p>

            <p>
                <label>Mobile Phone</label><?php echo htmlspecialchars($mobile_phone, ENT_QUOTES, 'UTF-8'); ?></p>

            <p>
                <label>Office Phone</label><?php echo htmlspecialchars($office_phone, ENT_QUOTES, 'UTF-8'); ?></p>

            <p>
                <label>Home Phone</label><?php echo htmlspecialchars($home_phone, ENT_QUOTES, 'UTF-8'); ?></p>

            <p>
                <label>Group</label><?php echo array_search($grp, $group_name_data); ?></p>

            <p>
                <label>Username</label><?php echo $username; ?></p>

            <p>
                <label>Supervisors</label><?php if ($supervisors) {
                    $sups = explode(',', $supervisors);
                    $sup_names = [];
                    foreach ($sups as $sup) {
                        $sup_names[] = array_search($sup, $supervisor_name_data);
                    }
                    echo rtrim(implode(', ', $sup_names), ', ');
                } ?></p>

            <p>
                <label>Status</label><?php echo htmlspecialchars($status, ENT_QUOTES, 'UTF-8'); ?></p>

            <p>
                <label>Date Created</label><?php echo extract_date_time($date_created); ?></p>

            <p>
                <label>Last Login</label><?php
            ...
            <p>
                <label>Last Case Activity</label><?php echo get_last_case_activity($dbh, $username); ?></p>
        ...
        <div class="user_detail_right">
            ...
            <p>
                ...
                <?php $active_cases = get_active_cases($dbh, $username);
            ...
            <p>
                ...
                <?php $t = get_total_hours($dbh, $username);
                echo implode(' ', $t); ?>
            <p>
        ...
        <form name="user_edit_form">
            ...
            <div class="user_detail_left">
                ...
                <p>
                    ...
                    <input name="first_name" type="text" value="<?php echo htmlspecialchars($first_name, ENT_QUOTES, 'UTF-8'); ?>">
                </p>

                <p>
                    <label>Last Name</label>
                    <input name="last_name" type="text" value="<?php echo htmlspecialchars($last_name, ENT_QUOTES, 'UTF-8'); ?>">
                </p>

                <p>
                    <label>Email</label>
                    <input name="email" type="text" value="<?php echo htmlspecialchars($email, ENT_QUOTES, 'UTF-8'); ?>">
                </p>

                <p>
                    <label>Mobile Phone</label>
                    <input name="mobile_phone" type="text" value="<?php echo htmlspecialchars($mobile_phone, ENT_QUOTES, 'UTF-8'); ?>">
                </p>

                <p>
                    <label>Office Phone</label>
                    <input name="office_phone" type="text" value="<?php echo htmlspecialchars($office_phone, ENT_QUOTES, 'UTF-8'); ?>">
                </p>

                <p>
                    <label>Home Phone</label>
                    <input name="home_phone" type="text" value="<?php echo htmlspecialchars($home_phone, ENT_QUOTES, 'UTF-8'); ?>">
                </p>
