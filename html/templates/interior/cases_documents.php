    ...
    <div class="case_detail_panel_tools_left">
        <div class="documents_view_chooser">
            ...
            if ($_COOKIE['cc_doc_view'] == 'grid') { ?>
                <input type="radio" id="radio_grid<?php echo $grid_id; ?>" class="radio_toggle_grid" name="radio<?php echo $radio_name; ?>" checked="checked">
                <label for="radio_grid<?php echo $grid_id; ?>">Grid</label>
                <input type="radio" id="radio_list<?php echo $list_id; ?>" class="radio_toggle_list" name="radio<?php echo $radio_name; ?>">
                <label for="radio_list<?php echo $list_id; ?>">List</label>
            <?php } else { ?>
                <input type="radio" id="radio_grid<?php echo $grid_id; ?>" class="radio_toggle_grid" name="radio<?php echo $radio_name; ?>" ">
                <label for="radio_grid<?php echo $grid_id; ?>">Grid</label>
                <input type="radio" id="radio_list<?php echo $list_id; ?>" class="radio_toggle_list" name="radio<?php echo $radio_name; ?>" checked="checked">
                <label for="radio_list<?php echo $list_id; ?>">List</label>
            <?php } ?>
        </div>
    </div>
...
<div class="case_documents_submenu">
    <img src="html/ico/house.png">
    <a href="#" class="doc_trail_home">Home</a>
    /
    <span class="path_display" path="">
        <a href="#" class="doc_trail_item active" path=""></a>
    </span>
</div>
