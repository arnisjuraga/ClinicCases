<div tabindex="2" class="user_display_detail <?php if ($data['case_status'] == "inactive") {
    echo "inactive_user";
} ?>" id="user_box_<?php echo $data['id'] . "_" . $data['username']; ?>">
    ...
    <p>
        <label>Total Time on this Case:</label>
    </p>
    ...
    <p><?php $grp = get_group_title($data['grp'], $dbh);
        echo $grp ?> </p>
    ...
    <p><?php $date_assigned = extract_date($data['date_assigned']);
        echo $date_assigned; ?></p>
