        ...
        <form>
            ...
            <div class='csenote_bar'>
                ...
                <div class='csenote_bar_left new_event_left'>
                    ...
                    <h4>
                        <span class="event_name_live">New Event</span>
                        <h4>
                ...
                <div class='csenote_bar_right new_event_right'>
                    ...
                    <button class='event_action_submit'>Add</button>
                    <button class='event_action_cancel'>Cancel</button>
            ...
            <div class="new_event_data">
                ...
                <p>
                    <label>What:</label>
                    <input type="text" name="task" class="long">
                </p>

                <p>
                    <label>Where:</label>
                    <input type="text" name="where" class="long">
                </p>
                ...
                <p>
                    <label>Notes:</label>
                    <textarea name="notes"></textarea></p>
