        ...
        <form>
            ...
            <div class='csenote_bar'>
                ...
                <div class='csenote_bar_left new_contact_left'>
                    ...
                    <h4>
                        <span class="first_name_live">New Contact</span>
                        <span class="last_name_live"></span>
                    </h4>

                    <h5>
                        <span class="contact_type_live"></span>
                    </h5>
                ...
                <div class='csenote_bar_right new_contact_right'>
                    ...
                    <button class='contact_action_submit'>Add</button>
                    <button class='contact_action_cancel'>Cancel</button>
            ...
            <div class="new_contact_data">
                ...
                <p>
                    ...
                    <input type="text" name="organization" id="contact_organization">
                </p>
                ...
                <p>
                    ...
                    <select name="contact_type" id="contact_type">
                        ...
                        <?php $type_list = gen_contact_types($dbh, $case_id);
                        echo $type_list; ?>
                ...
                <p>
                    <label>State</label><?php $select = state_selector('state', 'state_select');
                    echo $select; ?></p>
                ...
                <p>
                    <label>Notes</label>
                    <textarea name="notes" class="contact_notes"></textarea></p>
