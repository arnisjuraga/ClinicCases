...
<div id="content" class="content_login">
    ...
    <div class="wrapper">
        ...
        <div class="login_left">
            ...
            <form name="getin" id="getin">
                ...
                <p>
                    ...
                    <input type="text" id="username" name="username" value="<?php if (isset($_COOKIE['cc_user'])) {
                        $cookie_value = $_COOKIE['cc_user'];
                        echo $cookie_value;
                    } ?>">
                </p>
                ...
                <p>
                    <label for
                    "remember">Remember Username</label>
        ...
        <div class="login_right">
            ...
            <ul>
                <li>
                    <a class="lost_password" href="#">Forgot your username or password?</a>
                </li>
                <li>
                    <a href="newaccount/">Need an account?</a>
                </li>
                <li>Help and information available at
                    <a href="http://cliniccases.com">cliniccases.com</a>
                </li>
                <li>Ask questions at the
                    <a href="http://cliniccases.com/forums">ClinicCases forum</a>
                </li>
            </ul>
