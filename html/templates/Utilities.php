...
<div id="content">
    ...
    <div id="utilities_nav">
        ...
        <span class="utilities_nav_choices">
            ...
            <input type="radio" id="reports_button" name="radio" checked="checked"/>
            <label for="reports_button">Time Reports</label>

            <?php if ($_SESSION['permissions']['can_configure'] == '1') { ?>

                <input type="radio" id="config_button" name="radio"/>
                <label for="config_button">Configuration</label>

            <?php } ?>

            <?php if ($_SESSION['permissions']['add_case_notes'] == '1') { ?>

                <input type="radio" id="non_case_button" name="radio"/>
                <label for="non_case_button">Non-Case Time</label>
    ...
    <div id="utilities_panel" data-unit="<?php echo CC_TIME_UNIT; ?>">
        ...
        <div id="report_chooser" class="ui-toolbar ui-widget-header ui-corner-tl ui-corner-all">
            ...
            <p>
                <button class="report_submit">Go</button>
            </p>
